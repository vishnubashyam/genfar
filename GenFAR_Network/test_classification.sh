...
python3 main.py \
  --experiment test_run_classification \
  --experiment_type Classification \
  --experiment_tag Test \
  --data_csv /cbica/home/bashyamv/comp_space/1_Projects/15_NeuroFID/NeuroFID/DataPrep/Preprocessing/Lists/Training_Lists/Hyperlipidemia_Interpolated.csv \
